...
\t\t\t";
        // line 18
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["idArray"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
            // line 19
            echo "\t\t\t\t<td>
\t\t\t\t\t<a href=\"/event/delete/";
            // line 20
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["id"]), "html", null, true);
            echo "\">Edit</a>
\t\t\t\t</td>
\t\t\t\t<td>
\t\t\t\t\t<a href=\"/event/create?id=";
            // line 23
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["id"]), "html", null, true);
            echo "\">Delete</a>
\t\t\t\t</td>
...
";
    ...
    {
        return array (  121 => 26,  112 => 23,  106 => 20,  103 => 19,  99 => 18,  96 => 17,  87 => 15,  83 => 14,  76 => 9,  67 => 6,  64 => 5,  60 => 4,  55 => 1,);
    }
...
\t\t\t{% for id in idArray %}
\t\t\t\t<td>
\t\t\t\t\t<a href=\"/event/delete/{{ id }}\">Edit</a>
\t\t\t\t</td>
\t\t\t\t<td>
\t\t\t\t\t<a href=\"/event/create?id={{ id }}\">Delete</a>
\t\t\t\t</td>
\t\t\t{% endfor %}
