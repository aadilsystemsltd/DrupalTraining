...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["header"] ?? null), 0, [], "array"));
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 5
            echo "\t\t\t\t<th scope=\"col\">
\t\t\t\t\t";
            // line 6
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["i"], "Title", [], "array")), "html", null, true);
            echo "
\t\t\t\t</th>
\t\t\t";
        }
...
";
    ...
    {
        return array (  83 => 26,  76 => 9,  67 => 6,  64 => 5,  60 => 4,  55 => 1,);
    }
