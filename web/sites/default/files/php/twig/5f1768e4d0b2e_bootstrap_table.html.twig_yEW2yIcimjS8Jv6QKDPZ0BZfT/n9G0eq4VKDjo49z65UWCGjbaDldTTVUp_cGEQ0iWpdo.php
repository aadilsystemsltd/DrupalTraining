...
\t\t\t\t\t";
            // line 15
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($context["tr"], 0, [], "array"));
            foreach ($context['_seq'] as $context["_key"] => $context["td"]) {
                // line 16
                echo "\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t";
                // line 17
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["td"], "Title", [])), "html", null, true);
                echo "
\t\t\t\t\t\t</td>
\t\t\t\t\t";
            }
