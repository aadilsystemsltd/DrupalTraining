...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tr"]) {
            // line 15
            echo "\t\t\t\t<td>";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["tr"], "id", [], "array")), "html", null, true);
            echo "</td>
\t\t\t\t";
            // line 21
            echo "\t\t\t";
...
";
    ...
    {
        return array (  98 => 22,  92 => 21,  87 => 15,  83 => 14,  76 => 9,  67 => 6,  64 => 5,  60 => 4,  55 => 1,);
    }
