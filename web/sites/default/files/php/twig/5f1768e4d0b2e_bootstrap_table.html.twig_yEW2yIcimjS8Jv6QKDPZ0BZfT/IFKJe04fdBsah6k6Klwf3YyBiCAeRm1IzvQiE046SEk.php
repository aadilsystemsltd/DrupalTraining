...
\t\t\t\t";
            // line 23
            echo "\t\t\t\t<td><a href=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getPath("events.form.delete", ["node" => $this->getAttribute(($context["node"] ?? null), "id", [])]), "html", null, true);
            echo "\">Delete</a></td>
\t\t\t</tr>
\t\t";
        }
...
";
    ...
    {
        return array (  127 => 26,  117 => 23,  113 => 21,  109 => 20,  105 => 19,  101 => 18,  97 => 17,  93 => 16,  89 => 15,  86 => 14,  82 => 13,  76 => 9,  67 => 6,  64 => 5,  60 => 4,  55 => 1,);
    }
...
\t\t\t\t<td><a href=\"{{ path('events.form.delete', {'node': node.id}) }}\">Delete</a></td>
\t\t\t</tr>
\t\t{% endfor %}
\t</tbody>
