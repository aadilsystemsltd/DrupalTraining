...
\t\t\t\t";
            // line 22
            echo "\t\t\t\t<td><a href=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->getPath($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["events"] ?? null), "form", []), "create", []))));
            echo "\">Edit</a></td>
...
\t\t\t\t<td><a href=\"{{ path(events.form.create) }}\">Edit</a></td>
