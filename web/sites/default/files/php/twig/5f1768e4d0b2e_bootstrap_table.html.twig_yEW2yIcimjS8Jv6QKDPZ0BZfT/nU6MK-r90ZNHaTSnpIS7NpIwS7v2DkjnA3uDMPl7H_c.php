...
\t\t\t\t";
            // line 23
            echo "\t\t\t\t<td><a href=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getPath("events.form.delete", ["cid" => $this->getAttribute(($context["node"] ?? null), "id", [])]), "html", null, true);
            echo "\">Delete</a></td>
\t\t\t</tr>
\t\t";
        }
...
\t\t\t\t<td><a href=\"{{ path('events.form.delete', {'cid': node.id}) }}\">Delete</a></td>
\t\t\t</tr>
\t\t{% endfor %}
\t</tbody>
