...
\t\t\t\t\t";
            // line 15
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($context["tr"]);
            foreach ($context['_seq'] as $context["_key"] => $context["td"]) {
                // line 16
                echo "\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t";
                // line 17
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(twig_var_dump($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed($context["td"])]));
                echo "
\t\t\t\t\t\t\t";
                // line 18
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["td"]), "html", null, true);
                echo "
\t\t\t\t\t\t</td>
\t\t\t\t\t";
            }
...
";
    ...
    {
        return array (  116 => 23,  109 => 21,  100 => 18,  96 => 17,  93 => 16,  89 => 15,  86 => 14,  82 => 13,  76 => 9,  67 => 6,  64 => 5,  60 => 4,  55 => 1,);
    }
